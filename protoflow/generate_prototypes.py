...
from datasets.mvtec_test import MVTEC, VISA
...
class PrototypeModule(object):
    def __init__(self, args):
        ...
        train_dataset = VISA(args.data_path, class_name=args.class_name, train=True,
        ...
        self.embedding_path = os.path.join(f'weights/prototypes_visa', self.args.class_name)
...
def get_args():
    ...
    parser.add_argument('--data_path', default='/root/autodl-tmp/PMAD/data/visa')
    parser.add_argument('--class_name', default='candle')
...
if __name__ == '__main__':
    MVTEC_CLASS_NAMES = ['candle', 'capsules', 'cashew', 'chewinggum', 'fryum',
